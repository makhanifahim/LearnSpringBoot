...
import com.example.RecipeApp.repositories.CategoryRepositories;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Autowired
    @Lazy
    private final RecipeRepositories recipeRepository;
    @Autowired
    @Lazy
    private final UnitOfMeasureRepositories unitOfMeasureRepository;

    public RecipeBootstrap(CategoryRepositories categoryRepository, RecipeRepositories recipeRepository, UnitOfMeasureRepositories unitOfMeasureRepository) {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setSource("Simpley Recipes");
